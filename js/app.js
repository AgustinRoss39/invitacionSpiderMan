...
function updateCountdown() {
  ...
  if (now >= end) {
    finishCountdown("¡Gracias por sumarte a esta misión! 🕷");
    return;
  }

  if (now >= start) {
    finishCountdown("¡Hoy es el gran día! 🕸", "La misión ya empezó.");
    return;
  }
  ...
  if (days === 0) {
    ...
    countdownStatus.textContent = `Faltan ${days} días para la misión.`;
  }
}
